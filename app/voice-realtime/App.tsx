...
// UI components
import Transcript from "@/components/realtime/Transcript";
import Events from "@/components/realtime/Events";
import BottomToolbar from "@/components/realtime/BottomToolbar";
...
import { useTranscript } from "@/contexts/realtime/TranscriptContext";
import { useEvent } from "@/contexts/realtime/EventContext";
...
// Agent configs
import { lisaCareerAdvisorScenario } from "@/lib/agentConfigs/lisaCareerAdvisor";

// Single scenario configuration
const agents = lisaCareerAdvisorScenario;
const companyName = "PathFinder Career OS";
...
function App() {
  ...
  const [selectedAgentConfigSet] = useState<RealtimeAgent[]>(agents);
  ...
  const connectToRealtime = async () => {
    ...
    try {
      ...
      // Start session timer for conversation tracking
      startSession();
